...
if selected == "Customer Profile Input":
    ...
    with col1:
        ...
        policy_state = st.selectbox('Select policy State:', states    , index=None, help="Select Policy State/Location", placeholder="Select Policy State/Location")
        policy_deduc = st.selectbox('Select deductable:', policy_deduc_opt, index=None, help="Portion of a claim that policy holder responsible to pay.", placeholder="Portion of a claim that policy holder responsible to pay")
        ...
        insured_sex = st.selectbox('Select gender:', ['Male', 'Female'], index=None, help="Customer Gender", placeholder="Customer Gender")
        education = st.selectbox('Select education:', edu_opt, index=None, help="Customer education Level", placeholder="Customer education Level")
        occupation = st.selectbox('Select occupation:', occu_opt, index=None, help="Customer occupation", placeholder="Customer occupation")
        hobbies = st.selectbox('Select hobbies:', hobbies_opt, index=None, help="Select hobbies", placeholder="Select hobbies")
        insured = st.selectbox('Select insured relation:', insured_opt, index=None, help="Select insured relation", placeholder="Select insured relation")

    with col2:
        auto_make = st.selectbox('Select auto make:', make_opt, index=None, help="Select Vehicle make", placeholder="Select Vehicle make")
        year = st.selectbox('Select make year:', [i for i in range(1994, 2016)], index=None, help="Select Vehicle make year", placeholder="Select Vehicle make year")
        incident_type = st.selectbox('Select incident type:', incident_opt, index=None, help="Select incident type", placeholder="Select incident type")
